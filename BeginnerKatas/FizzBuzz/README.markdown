...
>
>>Any number divisible by three is replaced by the word *Fizz* and any divisible by five by the word *Buzz*. Numbers divisible by both become *FizzBuzz*. Start with a random number. An example output could be:
>>
